...
var Fs = L((x) => {
  ...
  var np = Array.from({ length: 256 }, (e, t) =>
...
var yi = {
  enabled:
    !di && mi == null && fi !== "dumb" && ((Qr != null && Qr !== "0") || gi)
};
function T(e, t) {
...
var rc = (e) => e,
  ...
  f = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++nc }),
          e.__id
        );
      },
        ...
        for (let re = 0; re < C.length; ++re) {
          ...
          for (let _ = n, ne = i; _ < t.length; ne += t[_].length, ++_) {
            ...
            if (Pe && _ != t.length - 1) {
              ...
              for (
                let bl = t.length;
                a < bl && (l < y || (!t[a].type && !t[a - 1].greedy));
                ++a
              )
...
function cc(
  ...
  if (c && u) {
    ...
    ((s.functionName = `${y.code})`),
      (s.location = a),
      n ||
        (c = c.mapLineAt(a.lineNumber, (g) => g.slice(0, y.openingBraceIndex))),
...
function Lp(e, t = Xs) {
  ...
  if (e > Zs)
    throw new be(
      ...
      `Cannot encode a time larger than ${Zs}: ${e}`
    );
  ...
  let r,
    n = "";
  for (let i = t; i > 0; i--)
    ((r = e % Rt), (n = Ys.charAt(r) + n), (e = (e - r) / Rt));
  return n;
}
function $p() {
...
function Qe() {
  return (
    br > Er.length - 16 && ((0, ta.randomFillSync)(Er), (br = 0)),
    Er.slice(br, (br += 16))
  );
}
...
function jp(e, t) {
  if (t.pagination) {
    ...
    if ((r !== null && r > 0) || n === 0 || (i !== null && !qe(e, i)))
      return null;
  }
      ...
      case "execute": {
        ...
        for (let a of o) {
          ...
          s += await this.#d(l, r, () =>
            r
              .executeRaw(l)
              .catch((c) => (t.args.type === "rawSql" ? yn(c) : Ve(c)))
          );
        }
        return { value: s };
      }
        ...
        for (let a of o) {
          let l = this.#m(a),
            c = await this.#d(l, r, () =>
              r
                .queryRaw(l)
                .catch((u) => (t.args.type === "rawSql" ? yn(u) : Ve(u)))
            );
          s === void 0
            ? (s = c)
            : (s.rows.push(...c.rows), (s.lastInsertId = c.lastInsertId));
        }
        return {
        ...
        case "waiting":
          if (n.signal.aborted)
            throw (
              o
                .then((s) => s.rollback())
                .catch((s) => We("error in discarded transaction:", s)),
      ...
      let n = async () => {
        ...
        try {
          ...
          ((t.status = r),
            ...
            this.closedTransactions.length > od &&
...
${n.backtrace}`,
  ...
  async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
    ...
    try {
      c = this.#p(() =>
        this.#m({ queries: t, execute: () => l.compileBatch(s) })
      );
    } catch (u) {
      throw this.#u(u);
    }
...
`,
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new dl.AsyncResource("prisma-client-request").runInAsyncScope(() =>
          a(o)
        )
      );
    }
